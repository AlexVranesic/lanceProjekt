...
ALTER TABLE FREELANCE.GEAR_CLAIM
ADD COLUMN is_valid INTEGER
ADD COLUMN claim_value DOUBLE
ADD COLUMN claim_date DATE
ADD COLUMN return_account_number VARCHAR(100);

ALTER TABLE FREELANCE.CONTRACT
ADD COLUMN is_valid INTEGER
ADD COLUMN claim_value DOUBLE
ADD COLUMN claim_date DATE
ADD COLUMN return_account_number VARCHAR(100);

ALTER TABLE FREELANCE.SICK_DAY_CLAIM
ADD COLUMN is_valid INTEGER
ADD COLUMN claim_value DOUBLE
ADD COLUMN claim_date DATE
ADD COLUMN return_account_number VARCHAR(100);

ALTER TABLE FREELANCE.LIABILITY_CLAIM
ADD COLUMN is_valid INTEGER
ADD COLUMN claim_value DOUBLE
ADD COLUMN claim_date DATE
ADD COLUMN return_account_number VARCHAR(100);
...
ALTER TABLE FREELANCE.CONTRACT
DROP CONSTRAINT contrac_policie_FK;

ALTER TABLE FREELANCE.CONTRACT
DROP COLUMN ID_policy
DROP COLUMN ID_claim
ADD COLUMN ID_policy_product INTEGER;
	
ALTER TABLE FREELANCE.CONTRACT ADD CONSTRAINT contr_pol_prod_FK FOREIGN KEY
(ID_policy_product)
REFERENCES FREELANCE.POLICY_PRODUCT
(ID_policy_product)
ON DELETE CASCADE;
