...
ALTER TABLE FREELANCE.CONTRACT DROP FOREIGN KEY contra_compani_FK;
DROP TABLE FREELANCE.COMPANY;
...
ALTER TABLE FREELANCE.CONTRACT RENAME COLUMN ID_company TO ID_clients_client;
